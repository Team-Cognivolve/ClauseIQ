...
**ClauseIQ** is a privacy-first, local-scale AI platform designed to audit freelance contracts for predatory "red flags." By leveraging **WebGPU acceleration**, ClauseIQ runs high-performance LLMs directly in your browser. 
